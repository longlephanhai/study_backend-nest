...
export class Part7Controller {
  ...
  @Post('multiple')
  @ResponseMessage('Multiple Part7 created successfully')
  createMultiple(@Body() createPart7Dtos: CreatePart7Dto[], @User() user: IUser) {
    return this.part7Service.createMultiple(createPart7Dtos, user);
  }
