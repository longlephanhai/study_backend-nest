...
export class Part4Controller {
  ...
  @Post('multiple')
  @ResponseMessage('Multiple Part4 created successfully')
  createMultiple(@Body() createPart4Dtos: CreatePart4Dto[], @User() user: IUser) {
    return this.part4Service.createMultiple(createPart4Dtos, user);
  }
