...
export class Part6Controller {
  ...
  @Post('multiple')
  @ResponseMessage('Multiple Part6 created successfully')
  createMultiple(@Body() createPart6Dtos: CreatePart6Dto[], @User() user: IUser) {
    return this.part6Service.createMultiple(createPart6Dtos, user);
  }
